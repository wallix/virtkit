...
Applies to: `virtkit/**`, `virtkit-agent/**`.
...
- Deterministic seeds for property/fuzz tests. Co-locate fast unit tests; heavier integration tests under `tests/` (e.g. `virtkit-agent/tests/exec.rs`).
